...
typedef NS_ENUM(NSUInteger, StationKind) {
    ...
    StationKindTram             = 11,
    StationKindLightVruVehicle  = 12,
    StationKindAnimal           = 13,
    StationKindAgricultural     = 14,
    StationKindRoadSideUnit     = 15,
    StationKindSingleObject     = 1000,
    StationKindMultipleObjects  = 1001,
    StationKindBulkMaterial     = 1002
};
