...
@property(readonly, weak) VruMotionPredictionContainerImpl* motionPrediction;
...
- (void)setVruProfileSubprofileWithProfileIndex:(NSInteger)profileIndex andSubprofileIndex:(NSInteger)subprofileIndex;
@end
