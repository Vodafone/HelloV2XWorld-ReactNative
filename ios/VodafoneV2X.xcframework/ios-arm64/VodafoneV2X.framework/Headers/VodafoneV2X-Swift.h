...
SWIFT_CLASS("_TtC11VodafoneV2X12CPMConstants")
@interface CPMConstants : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) ProtocolVersion protocolVersion;)
+ (ProtocolVersion)protocolVersion SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) MessageID messageID;)
+ (MessageID)messageID SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11VodafoneV2X31CpmManagementContainerConstants")
@interface CpmManagementContainerConstants : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) StationKind stationType;)
+ (StationKind)stationType SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) CLLocationDegrees latitude;)
+ (CLLocationDegrees)latitude SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSString * _Nullable pictogram;
@property (nonatomic, readonly, copy) NSString * _Nullable uuid;
- (nonnull instancetype)initWithNature:(NSInteger)nature serialNumber:(NSInteger)serialNumber pictogram:(NSString * _Nullable)pictogram speedMax:(NSInteger)speedMax speedUnit:(NSInteger)speedUnit category:(NSString * _Nullable)category OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)roadSignUUIDWithCategory:(NSString * _Nonnull)category SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSArray<TrafficLighMovementImpl *> * _Nonnull trafficLightMovements;
@end
...
@property (nonatomic, readonly) NSInteger signalGroup;
@property (nonatomic, readonly, copy) NSArray<TrafficLighMovementImpl *> * _Nonnull trafficLightMovements;
- (nonnull instancetype)initWithIntersectionRegion:(NSInteger)intersectionRegion intersectionID:(NSInteger)intersectionID signalGroup:(NSInteger)signalGroup trafficLightMovements:(NSArray<TrafficLighMovementImpl *> * _Nonnull)trafficLightMovements OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
